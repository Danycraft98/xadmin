...
class ResultField(object):
    ...
    def val(self):
        ...
        if force_bytes(text) == '' or text == 'None' or text == EMPTY_CHANGELIST_VALUE:
            text = mark_safe(
...
class DetailAdminView(ModelAdminView):
    ...
    def get_context(self):
        new_context = {
            'title': _('%s Detail') % force_bytes(self.opts.verbose_name),
            'form': self.form_obj,
    ...
    def get_breadcrumb(self):
        ...
        item = {'title': force_bytes(self.obj)}
