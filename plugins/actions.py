...
def action_checkbox(obj):
    return checkbox.render(ACTION_CHECKBOX_NAME, force_bytes(obj.pk))
...
class DeleteSelectedAction(BaseActionView):
    ...
    def do_action(self, queryset):
        ...
        if len(queryset) == 1:
            objects_name = force_bytes(self.opts.verbose_name)
        else:
            objects_name = force_bytes(self.opts.verbose_name_plural)
